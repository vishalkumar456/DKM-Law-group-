...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="19x16" href="../img/incon.png">
    <!-- Custom CSS -->
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><button type="button" class="btn btn-outline-danger"><a href="../includes/logout.php">Logout</a></button></li>
            ...
            <div class="container-fluid">
                ...
                <!-- <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total Rigestred Users</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <?php
                                     $check="SELECT ID From users ORDER BY ID";
                                     $exec_check=mysqli_query($conn,$check);
                                     $row=mysqli_num_rows($exec_check);
                                     echo"$row";
                                    ?>
                                </span></li>
                            </ul>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total Lawyers Rigestered</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                                ...
                                <li class="ms-auto"><span class="counter text-purple">
                                    <?php
                                     $check="SELECT Law_ID From lawyers ORDER BY Law_ID";
                                     $exec_check=mysqli_query($conn,$check);
                                     $row=mysqli_num_rows($exec_check);
                                     echo"$row";
                                    ?>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title">Appointments Booked Yearly</h3>
                            <div class="d-md-flex">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Recent Appointments</h3>
