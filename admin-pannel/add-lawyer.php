                                ...
                                <div class = "form-row">
                                    <div class = "form-group col-md-6">
                                        ...
                                        <input type = "text" class =" form-control" 
                                            id = "inputEmail4" placeholder = "Lawyer's Full Name" name="L_Name">
                                    </div>
                                    
                                    <div class = "form-group col-md-6">
                                        <label for = "inputPassword4">CNIC</label>
                                        <input type = "tel" class = "form-control" 
                                            id = "inputPassword4" placeholder = "Lawyer's CNIC" name="CNIC">
                                    </div>
                                    </div>
                                    ...
                                    <!-- <div class = "form-row">
                                    <div class = "form-group col-md-6">
                                        <label for = "inputCity">Lawyer's Profession</label>
                                        <input type = "text" class = "form-control" placeholder = "Lawyer's Profession" name="Law_Pro"
                                            id = "inputCity">
                                    </div> -->
