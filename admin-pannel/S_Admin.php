...
$FL_Data = "SELECT * FROM lawyers WHERE Role =1";
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">All Lawyers Data</h4>
                    </div>
                        ...
                        <div class="white-box">
                            ...
                            <table class="table ">
                                ...
                                <tbody>
                                    ...
                                    <td><?php echo $row['Law_Pro'];?></td>
                                    <td><?php echo $row['Law_Con'];?></td>
                                    <td><?php echo $row['Law_Email'];?></td>
                                    <td><?php echo $row['Law_Date'];?></td>
                                    <td>
                                        <a href="edit-lawyer.php?id=<?php echo $row['Law_ID'] ?>" type="button" class="btn btn-primary">Edit</a>
                                        <a  href="delete-lawyer.php?id=<?php echo $row['Law_ID'] ?>" type="button" class="btn btn-secondary">Delete</a>
                                    </td>
                                    </tr>
                                    <?php
