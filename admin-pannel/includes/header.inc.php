                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                         ...
                         <li>
                             <!-- <a class="profile-pic btn btn-outline-danger rounded" href="../includes/logout.php" type="button">
                              <span class="" >Logout</span></a> -->
                              <button type="button" class="btn btn-outline-danger text-white font-medium" ><a href="../includes/logout.php">Logout</a></button>
